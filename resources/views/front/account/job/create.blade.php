                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    <label for="" class="mb-2">Loại<span class="req">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select" name="job_type_id" id="jobType">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Vị trí công việc<span class="req">*</span></label>
                                    <input type="text" placeholder="Location" id="location" name="location" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Miêu tả<span class="req">*</span></label>
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Trình độ chuyên môn</label>
                            ...
                            <h3 class="fs-4 mb-1 mt-5 border-top pt-5">Chi tiết thông tin</h3>
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Trang web</label>
