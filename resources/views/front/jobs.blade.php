            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action="" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Từ khóa</h2>
                            <input value="{{ Request::get('keyword') }}" type="text" name="keyword" id="keyword" placeholder="Từ khóa" class="form-control">
                        </div>

                        <div class="mb-4">
                            <h2>Vị trí</h2>
                            <input value="{{ Request::get('location') }}" type="text" name="location" id="location" placeholder="Vị trí" class="form-control">
                        </div>
                        ...
                        <a href="{{ route('jobs') }}" class="btn btn-secondary mt-3">Cài lại</a>
                    </div>
                </form>
            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ Str::words($jobs->description,$words=10,'...') }}</p>
                                            ...
                                            <div class="bg-light p-3 border">
                                                ...
                                                {{-- <p>Keywords: {{ $jobs->keywords }}</p>
                                                <p>Category: {{ $jobs->category->name }}</p>
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail',$jobs->id) }}" class="btn btn-primary btn-lg">Chi tiết</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
